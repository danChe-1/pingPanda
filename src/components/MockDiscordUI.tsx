    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] overflow-hidden rounded-lg bg-discord-background text-white shadow-xl">
      ...
      <div className="hidden w-[72px] flex-col items-center bg-[#202225] py-3 sm:flex">
        <div className="mb-2 flex size-12 items-center justify-center rounded-2xl bg-discord-brand-color transition-all duration-200 hover:rounded-xl">
          <Icons.discord className="text-whites size-3/5" />
        </div>
      ...
      <div className="hidden w-60 flex-col bg-[#2f3136] md:flex">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="mb-4 px-2">
            <div className="flex cursor-not-allowed items-center rounded-xl px-2 py-1.5 text-sm text-[#dcddde] hover:bg-[#393c43]">
        ...
        <div className="flex items-center bg-[#292b2f] p-2">
          ...
          <div className="flex items-center space-x-2">
            <Mic className="size-5 cursor-pointer text-[#b9bbbe]" />
            <Headphones className="size-5 cursor-pointer text-[#b9bbbe]" />
            <Cog className="size-5 cursor-pointer text-[#b9bbbe]" />
          </div>
        </div>
      </div>
      {/*  Ma in Content*/}
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex h-16 items-center border-b border-[#202225] bg-[#36393f] px-4 shadow-sm">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            <Phone className="hidden size-5 cursor-not-allowed text-[#b9bbbe] hover:text-white sm:block" />
            <Video className="hidden size-5 cursor-not-allowed text-[#b9bbbe] hover:text-white sm:block" />
            <UserCircle className="hidden size-5 cursor-not-allowed text-[#b9bbbe] hover:text-white sm:block" />
            <Search className="hidden size-5 cursor-not-allowed text-[#b9bbbe] hover:text-white sm:block" />
            <Inbox className="hidden size-5 cursor-not-allowed text-[#b9bbbe] hover:text-white sm:block" />
          </div>
        </div>
        {/*message history */}
